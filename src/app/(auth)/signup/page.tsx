  ...
  return (
        <div className="min-h-screen bg-foundation-white-light-hover flex flex-col justify-center items-center px-4">
          ...
          <div className="bg-foundation-white-light-hover p-8 rounded-lg shadow-lg w-full max-w-md">
            <h1 className="leading-tight text-large font-bold mb-4 font-sf-pro-display text-foundation-blue-dark">Let’s explore together!</h1>
            <p className="mb-8 text-nav-grey text-medium font-normal font-sf-pro-display">Create your Placoo account to explore your dream place to live across the whole world!</p>
            ...
            <form className="space-y-4 font-sf-pro-display" onSubmit={handleSubmit(onSubmit)}>
              ...
              <Button label="Create account" variant="outline" onClick={() => {}} />
            </form>
